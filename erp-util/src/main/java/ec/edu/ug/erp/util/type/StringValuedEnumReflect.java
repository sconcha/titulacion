...
public class StringValuedEnumReflect {
     ...
     * @return enum instance
     */
	public static <T extends Enum<T> & CharValuedEnum<T>> T getEnumFromValue(Class<T> enumClass, Character value) {
        T[] values = getValues(enumClass);
        for (T v : values){
	 ...
	 */
	public static <T extends Enum<T> & StringValuedEnum<T>> String getValueFromEnum(T enumInstance) {
	 ...
	 * @return
	 */
	public static <T extends Enum<T> & StringValuedEnum<T>> String getLabelKeyFromEnum(T enumInstance) {
	...
	public static <T extends Enum<T> & CharValuedEnum<T>> Map<Long, T> getMapFromString(Class<T> enumClass, String string, T defaultEnumValue) {
	...
	public static <T extends Enum<T> & CharValuedEnum<T>> String getStringFromMap(Map<Long, T> map, T defaultEnumValue, int max) {
