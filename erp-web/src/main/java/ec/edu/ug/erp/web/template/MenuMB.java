...
public class MenuMB implements Serializable {
	...
	private MenuModel loadMenu() {
		...
		/*
		 * List<ModuloDTO> modulos=new ArrayList<ModuloDTO>(); try { modulos =
		 * seguridadService.loadModuleList();
		 * 
		 * for (ModuloDTO modulo : modulos) { DefaultSubMenu submenu=new
		 * DefaultSubMenu(); submenu.setLabel(modulo.getDescripcion());
		 * submenu.setIcon(modulo.getIcono()); menu.addElement(submenu); }
		 */
